...
export interface IAuthorsClient {
    getAuthorsWithPagination(pageNumber: number | undefined, pageSize: number | undefined): Observable<PaginatedListOfAuthorDto>;
    create(command: CreateAuthorCommand): Observable<number>;
    getLookup(): Observable<LookupDto[]>;
    update(id: number, command: UpdateAuthorCommand): Observable<FileResponse>;
...
export class AuthorsClient implements IAuthorsClient {
    ...
    getAuthorsWithPagination(pageNumber: number | undefined, pageSize: number | undefined): Observable<PaginatedListOfAuthorDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAuthorsWithPagination(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAuthorsWithPagination(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PaginatedListOfAuthorDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PaginatedListOfAuthorDto>;
        }));
    }

    protected processGetAuthorsWithPagination(response: HttpResponseBase): Observable<PaginatedListOfAuthorDto> {
        ...
        if (status === 200) {
            ...
            result200 = PaginatedListOfAuthorDto.fromJS(resultData200);
    ...
    getLookup(): Observable<LookupDto[]> {
        let url_ = this.baseUrl + "/api/Authors/Lookup";
        url_ = url_.replace(/[?&]$/, "");
...
export interface IBooksClient {
    getBooksWithPagination(pageNumber: number | undefined, pageSize: number | undefined, name: string | null | undefined, publicationDt: Date | null | undefined, categoryId: number | null | undefined, authorId: number | null | undefined): Observable<PaginatedListOfBookDto>;
...
export class BooksClient implements IBooksClient {
    ...
    getBooksWithPagination(pageNumber: number | undefined, pageSize: number | undefined, name: string | null | undefined, publicationDt: Date | null | undefined, categoryId: number | null | undefined, authorId: number | null | undefined): Observable<PaginatedListOfBookDto> {
        ...
        if (publicationDt !== undefined && publicationDt !== null)
            url_ += "PublicationDt=" + encodeURIComponent(publicationDt ? "" + publicationDt.toISOString() : "") + "&";
    ...
    getLookup(): Observable<LookupDto[]> {
        let url_ = this.baseUrl + "/api/Books/Lookup";
        url_ = url_.replace(/[?&]$/, "");
...
export interface IBorrowersClient {
    getBorrowersWithPagination(pageNumber: number | undefined, pageSize: number | undefined): Observable<PaginatedListOfBorrowerDto>;
    create(command: CreateBorrowerCommand): Observable<number>;
    getLookup(): Observable<LookupDto[]>;
    update(id: number, command: UpdateBorrowerCommand): Observable<FileResponse>;
    delete(id: number): Observable<FileResponse>;
}
...
export class BorrowersClient implements IBorrowersClient {
    ...
    getBorrowersWithPagination(pageNumber: number | undefined, pageSize: number | undefined): Observable<PaginatedListOfBorrowerDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetBorrowersWithPagination(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetBorrowersWithPagination(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PaginatedListOfBorrowerDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PaginatedListOfBorrowerDto>;
        }));
    }

    protected processGetBorrowersWithPagination(response: HttpResponseBase): Observable<PaginatedListOfBorrowerDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PaginatedListOfBorrowerDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    getLookup(): Observable<LookupDto[]> {
        let url_ = this.baseUrl + "/api/Borrowers/Lookup";
        url_ = url_.replace(/[?&]$/, "");
...
export interface IBorrowsClient {
    getBorrowsWithPagination(pageNumber: number | undefined, pageSize: number | undefined, type: QueryType | undefined, bookId: number | null | undefined, borrowerId: number | null | undefined, created: Date | null | undefined, replayDt: Date | null | undefined, duration: number | null | undefined, price: number | null | undefined): Observable<PaginatedListOfBorrowDto>;
    create(command: CreateBorrowCommand): Observable<BorrowDto>;
    getBorrow(id: number): Observable<BorrowDto>;
    update(id: number, command: UpdateBorrowCommand): Observable<FileResponse>;
    delete(id: number): Observable<FileResponse>;
}
...
export class BorrowsClient implements IBorrowsClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getBorrowsWithPagination(pageNumber: number | undefined, pageSize: number | undefined, type: QueryType | undefined, bookId: number | null | undefined, borrowerId: number | null | undefined, created: Date | null | undefined, replayDt: Date | null | undefined, duration: number | null | undefined, price: number | null | undefined): Observable<PaginatedListOfBorrowDto> {
        let url_ = this.baseUrl + "/api/Borrows?";
        if (pageNumber === null)
            throw new Error("The parameter 'pageNumber' cannot be null.");
        else if (pageNumber !== undefined)
            url_ += "PageNumber=" + encodeURIComponent("" + pageNumber) + "&";
        ...
        if (borrowerId !== undefined && borrowerId !== null)
            url_ += "BorrowerId=" + encodeURIComponent("" + borrowerId) + "&";
        if (created !== undefined && created !== null)
            url_ += "Created=" + encodeURIComponent(created ? "" + created.toISOString() : "") + "&";
        if (replayDt !== undefined && replayDt !== null)
            url_ += "ReplayDt=" + encodeURIComponent(replayDt ? "" + replayDt.toISOString() : "") + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetBorrowsWithPagination(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetBorrowsWithPagination(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PaginatedListOfBorrowDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PaginatedListOfBorrowDto>;
        }));
    }

    protected processGetBorrowsWithPagination(response: HttpResponseBase): Observable<PaginatedListOfBorrowDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PaginatedListOfBorrowDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<BorrowDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<BorrowDto>;
        }));
    }

    protected processCreate(response: HttpResponseBase): Observable<BorrowDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = BorrowDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    getBorrow(id: number): Observable<BorrowDto> {
        let url_ = this.baseUrl + "/api/Borrows/Borrow/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetBorrow(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetBorrow(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<BorrowDto>;
                }
            } else
    ...
    protected processGetBorrow(response: HttpResponseBase): Observable<BorrowDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    update(id: number, command: UpdateBorrowCommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/Borrows/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
...
export interface ICategoriesClient {
    getCategoriessWithPagination(pageNumber: number | undefined, pageSize: number | undefined): Observable<PaginatedListOfCategoryDto>;
...
export class CategoriesClient implements ICategoriesClient {
    ...
    getCategoriessWithPagination(pageNumber: number | undefined, pageSize: number | undefined): Observable<PaginatedListOfCategoryDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCategoriessWithPagination(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCategoriessWithPagination(response_ as any);
                } catch (e) {
    ...
    protected processGetCategoriessWithPagination(response: HttpResponseBase): Observable<PaginatedListOfCategoryDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    getLookup(): Observable<LookupDto[]> {
        let url_ = this.baseUrl + "/api/Categories/Lookup";
        url_ = url_.replace(/[?&]$/, "");
...
export class PaginatedListOfAuthorDto implements IPaginatedListOfAuthorDto {
    items?: AuthorDto[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
    ...
    constructor(data?: IPaginatedListOfAuthorDto) {
        if (data) {
    ...
    static fromJS(data: any): PaginatedListOfAuthorDto {
        data = typeof data === 'object' ? data : {};
        let result = new PaginatedListOfAuthorDto();
        result.init(data);
        return result;
    }
...
export interface IPaginatedListOfAuthorDto {
    items?: AuthorDto[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
...
export class BookDto implements IBookDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.name = _data["name"];
            this.numberPages = _data["numberPages"];
            this.publicationDt = _data["publicationDt"] ? new Date(_data["publicationDt"].toString()) : <any>undefined;
    ...
    toJSON(data?: any) {
        ...
        data["id"] = this.id;
        data["name"] = this.name;
        data["numberPages"] = this.numberPages;
        data["publicationDt"] = this.publicationDt ? this.publicationDt.toISOString() : <any>undefined;
...
export class PaginatedListOfBorrowerDto implements IPaginatedListOfBorrowerDto {
    items?: BorrowerDto[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
    ...
    constructor(data?: IPaginatedListOfBorrowerDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(BorrowerDto.fromJS(item));
            }
            this.pageNumber = _data["pageNumber"];
            this.totalPages = _data["totalPages"];
            this.totalCount = _data["totalCount"];
    ...
    static fromJS(data: any): PaginatedListOfBorrowerDto {
        data = typeof data === 'object' ? data : {};
        let result = new PaginatedListOfBorrowerDto();
        result.init(data);
        return result;
    }
...
export interface IPaginatedListOfBorrowerDto {
    items?: BorrowerDto[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
...
export class CreateBorrowerCommand implements ICreateBorrowerCommand {
    name?: string;
    address?: string;
    phone?: string;

    constructor(data?: ICreateBorrowerCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateBorrowerCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateBorrowerCommand();
        result.init(data);
        return result;
    }
...
export interface ICreateBorrowerCommand {
    name?: string;
    address?: string;
    phone?: string;
}
...
export class PaginatedListOfBorrowDto implements IPaginatedListOfBorrowDto {
    items?: BorrowDto[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
    ...
    constructor(data?: IPaginatedListOfBorrowDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(BorrowDto.fromJS(item));
            }
            this.pageNumber = _data["pageNumber"];
            this.totalPages = _data["totalPages"];
            this.totalCount = _data["totalCount"];
    ...
    static fromJS(data: any): PaginatedListOfBorrowDto {
        data = typeof data === 'object' ? data : {};
        let result = new PaginatedListOfBorrowDto();
        result.init(data);
        return result;
    }
...
export interface IPaginatedListOfBorrowDto {
    items?: BorrowDto[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
...
export class BorrowDto implements IBorrowDto {
    id?: number;
    bookId?: number;
    borrowerId?: number;
    created?: Date;
    replayDt?: Date | undefined;
    duration?: number;
    price?: number;
    isLate?: boolean;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.replayDt = _data["replayDt"] ? new Date(_data["replayDt"].toString()) : <any>undefined;
            this.duration = _data["duration"];
            this.price = _data["price"];
            this.isLate = _data["isLate"];
            this.isNearExpiry = _data["isNearExpiry"];
            this.finished = _data["finished"];
            this.dayLate = _data["dayLate"];
            this.fines = _data["fines"];
            this.book = _data["book"];
            this.borrower = _data["borrower"] ? BorrowerDto.fromJS(_data["borrower"]) : <any>undefined;
        }
    }

    static fromJS(data: any): BorrowDto {
        data = typeof data === 'object' ? data : {};
        let result = new BorrowDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["replayDt"] = this.replayDt ? this.replayDt.toISOString() : <any>undefined;
        data["duration"] = this.duration;
        data["price"] = this.price;
        data["isLate"] = this.isLate;
        data["isNearExpiry"] = this.isNearExpiry;
        data["finished"] = this.finished;
        data["dayLate"] = this.dayLate;
...
export class CreateBorrowCommand implements ICreateBorrowCommand {
    bookId?: number;
    ...
    constructor(data?: ICreateBorrowCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateBorrowCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateBorrowCommand();
        result.init(data);
        return result;
    }
...
export interface ICreateBorrowCommand {
    bookId?: number;
    borrowerId?: number | undefined;
    duration?: number;
    price?: number;
...
export class Borrower extends BaseAuditableEntity implements IBorrower {
    name?: string;
    address?: string;
    phone?: string;
    borrows?: Borrow[] | undefined;
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["borrows"])) {
                ...
                for (let item of _data["borrows"])
                    this.borrows!.push(Borrow.fromJS(item));
            }
        }
    }

    static override fromJS(data: any): Borrower {
        data = typeof data === 'object' ? data : {};
...
export interface IBorrower extends IBaseAuditableEntity {
    name?: string;
    address?: string;
    phone?: string;
    borrows?: Borrow[] | undefined;
...
export class Borrow extends BaseAuditableEntity implements IBorrow {
    bookId?: number;
    borrowerId?: number;
    replayDt?: Date | undefined;
    duration?: number;
    ...
    static override fromJS(data: any): Borrow {
        data = typeof data === 'object' ? data : {};
        let result = new Borrow();
        result.init(data);
        return result;
    }
...
export interface IBorrow extends IBaseAuditableEntity {
    bookId?: number;
    borrowerId?: number;
    replayDt?: Date | undefined;
    duration?: number;
...
export class Book extends BaseAuditableEntity implements IBook {
    name?: string;
    numberPages?: number;
    categoryId?: number;
    authorId?: number;
    ...
    static override fromJS(data: any): Book {
        data = typeof data === 'object' ? data : {};
        let result = new Book();
        result.init(data);
        return result;
...
export interface IBook extends IBaseAuditableEntity {
    name?: string;
    numberPages?: number;
    categoryId?: number;
    authorId?: number;
...
export class Author extends BaseAuditableEntity implements IAuthor {
    name?: string;
    ...
    static override fromJS(data: any): Author {
        data = typeof data === 'object' ? data : {};
...
export interface IAuthor extends IBaseAuditableEntity {
    name?: string;
    address?: string | undefined;
    books?: Book[];
}

export class UpdateBorrowCommand implements IUpdateBorrowCommand {
    id?: number;
    duration?: number | undefined;
    price?: number | undefined;
    replayDt?: Date | undefined;

    constructor(data?: IUpdateBorrowCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateBorrowCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateBorrowCommand();
        result.init(data);
        return result;
    }
...
export interface IUpdateBorrowCommand {
    id?: number;
    duration?: number | undefined;
    price?: number | undefined;
    replayDt?: Date | undefined;
